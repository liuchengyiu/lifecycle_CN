...
class ParamActor(nn.Module):
    ...
    def forward(self, state):
        ...
        return torch.tanh(action_params)
...
class PDQNAgent(Agent):
    ...
    def __init__(self,
        ...
        self.action_parameter_sizes = np.array([10]*action_space_dim)
        self.action_parameter_size = int(self.action_parameter_sizes.sum())
        self.action_parameter_max_numpy = np.array([1]*10*action_space_dim)
        self.action_parameter_min_numpy = np.array([-1]*10*action_space_dim)
